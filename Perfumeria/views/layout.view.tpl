          ...
          <header>
            <nav>
                <section class="contenedor nav">
                    <div class="logo">
                        <img src="public/imgs/icono.png" alt="">
                    </div>
            ...
            <div class="footer">
                    <div class="footer-container">
                        <div class="footer-main">
                            ...
                            <div class="footer-columna">
                                <h3> Dirección</h3>
                                <span class="fas fa-map-marker"><p>Col. Centro America.</p></span>
                                <span class="fas fa-phone"><p>(+504) 2225-4144 </p></span>
                                <span class="fas fa-envelope"><p>deisyherrera7107@gmail.com</p></span>
                                <span class="fas fa-mobile-alt"><p>(+504) 9955-0494</p></span>
                            </div> 
                ...
                <div class="footer-copy-redes">
                    <div class="main-copy-redes">
                        <div class="footer-copy">
                            <p >&copy; 2020, Todos los Derechos Reservados - | Perfumeria Dazie |</p>
